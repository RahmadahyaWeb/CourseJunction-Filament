<div class="col-12 d-flex justify-content-center mt-4 mb-3">
    <div class="svg-illustration">
        <svg fill="#ff3e1d" height="200px" width="200px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
...
<div class="col-12">
    ...
    <p class="text-secondary text-center">
        Looks like something went completely wrong or maybe there is no data in here?!
    </p>
</div>
